...
import { GraduationCap, Eye, EyeOff, Lock, BadgeIcon as IdCard } from "lucide-react"
        ...
        <div className="p-8">
          ...
          >
            ...
            <p className="text-center text-muted-foreground mb-6">
              Entrez votre numéro d'inscription et mot de passe pour accéder à votre compte
            </p>
          </motion.div>
          ...
          >
            <div className="space-y-2">
              <Label htmlFor="registrationNumber">Identifiant (N° matricule)</Label>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-muted-foreground">Ou alors</span>
              </div>
            </div>
